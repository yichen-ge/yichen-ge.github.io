...
<div class="home-page-enhanced">
  <div class="home-hero">
    <p class="home-hero__greeting"><i class="fas fa-star" aria-hidden="true"></i> Hello, I am Yichen Ge.</p>
    <p class="home-hero__lead">I am a master's student in Artificial Intelligence at China University of Petroleum (Beijing), advised by Assoc. Prof. <a href="https://www.cup.edu.cn/cupai/szdw/jsml/08ceb4581fbf4ae39e34cbc88ab1e183.htm">Liping Zhu</a>, and I also collaborate closely with Assoc. Prof. <a href="https://www.cup.edu.cn/cupai/szdw/jsml/1f31d6059517408aad81992a92a03279.htm">Chengyang Li</a>. My research interests include computer vision, human motion generation, and generative models.</p>
    <p class="home-hero__lead"><strong>I am actively seeking Ph.D. opportunities starting in 2027.</strong></p>
    <div class="home-hero__actions">
      <a class="btn home-btn--primary" href="/publications/"><i class="fas fa-book-open" aria-hidden="true"></i> View Publications</a>
      <a class="btn btn--inverse home-btn--ghost" href="mailto:2024216101@student.cup.edu.cn"><i class="fas fa-envelope" aria-hidden="true"></i> Contact Me</a>
    </div>
  </div>
